<?php
    ...
    $sql="SELECT p.cod_producto,
          ...
          WHERE p.nombre LIKE '%".$palabra."%'"; //AND p.cod_categoria='".$categoria."' AND p.cod_marca=".$marca;

            if ($categoria !=0 & $marca !=0){
                $sql=$sql." AND p.cod_categoria='".$categoria."' AND p.cod_marca=".$marca;
            }
        ...
        <?php
            if ($cantidad==0) {
                ...
                <table class="table">
                    ...
                    <tr>
                        <td align="center"><a href="formBuscar"><input type="submit" value="volver"></a></td>
                    </tr>
                </table>
                <?php
            }else {
                ...
                <table class="table table-striped">
                    <tr>
                        <td colspan="8" align="center"><a href="formBuscar"><input type="submit" value="volver"></a></td>
                    </tr>
                    ...
                    ?>
                    <tr id="cantidad">
                        <td colspan="8">Se encontraron <?php echo $cantidad; ?> productos en la tabla</td>
                    </tr>
