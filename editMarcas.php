<?php
    ...
    $sql="UPDATE marcas SET nombre_marca='".$nombre_marca."' WHERE cod_marca=".$cod_marca;
        ...
        <?php
            if ($checkeo !=1) {
                ...
                <table class="table">
                    ...
                    <tr>
                        <td><a href="panelMarcas"><input type="submit" value="volver"></a></td>
                    </tr>
                </table>
                <?php
            }else {
